...
if __name__ == "__main__":
    ...
    def preprocess_func(examples):
        ...
        for i in range(len(examples["answer_chosen"])):
            ...
            pos_messages = [
                {"role": "user", "content": examples["prompt"][i] + " " + examples["question"][i]},
                {"role": "assistant", "content": examples["answer_chosen"][i]},
            ]
            neg_messages = [
                {"role": "user", "content": examples["prompt"][i] + " " + examples["question"][i]},
                {"role": "assistant", "content": examples["answer_rejected"][i]},
            ]
