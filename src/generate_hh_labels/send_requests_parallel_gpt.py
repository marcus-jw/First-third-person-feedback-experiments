...
#"harmless-base", "helpful-base", "helpful-online", "helpful-rejection-sampled"
    ...
    for perspective in ["1_1", "3_1", "1_3", "3_3"]:
        requests_filepath = os.path.dirname(__file__) + f"/../../data/hh_labels/{split}_{train_test}_requests_{perspective}.jsonl"
        save_filepath = os.path.dirname(__file__) + f"/../../data/hh_labels/{split}_{train_test}_results_{perspective}.jsonl"
