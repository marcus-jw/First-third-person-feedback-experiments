...
for perspective in ["1_1","3_1","1_3","3_3"]:
    response_path = os.path.dirname(__file__) + f"/../../data/hh_labels/{train_test}_results_{perspective}.jsonl"
    save_path = os.path.dirname(__file__) + f"/../../data/hh_labels/hh_{train_test}_{perspective}.jsonl"
